...
- Treatment of quercetin had reduced the proliferation rates of colon HCT116 and breat MDA-MB-231 cancer cells.[^3]

#### Cancer chemopreventive agent

Treatment with quercetin dihydrate has been shown to promote the killing activity of T cells on cancer cells.[^6]
...
Several in-vitro studies have reported that quercetin demonstrates neuroprotection.[^1]

Quercetin's metabolites after absorption have all been shown to afford neuroprotection as well.[^1]

Quercetin protects against progressive dopaminergic neurodegeneration.[^1]

#### Neuroregeneration

Quesrcetin stimulates neuronal regeneration.[^1]
...
Quercetin Attenuates Atherosclerotic Inflammation[^4]
...
Quercetin protects against mitochondrial dysfunction.[^1]

Quercetin stimulates mitochondrial biogenesis.[^1]
...
Quercetin dihydrate has the exciting potential to be used as a cancer chemopreventive agent. Treatment with quercetin dihydrate has been shown to promote the killing activity of T cells on cancer cells.[^6]
...
Quercetin can significantly potentiate the cell protection and rescue effects of Nicotinamide adenine dinucleotide (NAD+).[^5]

Quercetin has been independently shown to significantly protect cells from DNA-damaging agents and induced cell death.[^5]
